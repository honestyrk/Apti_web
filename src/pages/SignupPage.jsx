    ...
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-12">
        <Card className="p-8 text-center">
          ...
          <h1 className="mt-5 font-heading text-xl font-bold text-slate-900">Check your inbox</h1>
          <p className="mt-2 text-sm leading-relaxed text-slate-500">
            We've sent a confirmation link to <span className="font-medium text-slate-700">{submittedEmail}</span>.
            Click the link to verify your account, then come back and log in.
          </p>

          {resendMessage && <p className="mt-4 text-sm text-slate-600">{resendMessage}</p>}
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-12">
      <Card className="p-8">
        ...
        <h1 className="mt-5 font-heading text-2xl font-bold text-slate-900">Create your account</h1>
